...
void from_json(const nlohmann::json& j, SubtitleStyleConfig& cfg) {
    ...
    if (j.contains("font")) {
        ...
        if (jf.contains("size")) {
            if (jf["size"].is_string())
                cfg.font_config.font_size = jf["size"];
            else
                cfg.font_config.font_size = std::to_string(jf["size"].get<int>());
        }
    ...
    if (j.contains("animation")) {
        ...
        if (a_type_str == "FadeIn")
            a_type = SubtitleAnimationType::FadeIn;
        else if (a_type_str == "SlideUp")
            a_type = SubtitleAnimationType::SlideUp;
        else if (a_type_str == "SlideDown")
            a_type = SubtitleAnimationType::SlideDown;
        else if (a_type_str == "ScaleUp")
            a_type = SubtitleAnimationType::ScaleUp;
        else if (a_type_str == "ScaleDown")
            a_type = SubtitleAnimationType::ScaleDown;

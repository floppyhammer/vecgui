...
void DefaultResource::init(const bool dark_mode) {
    ...
    auto ns = Font::from_file(get_asset_dir("fonts/NotoSans-Regular.ttf"));
    text_server->register_fallback_font(Script::Common, ns);
    text_server->register_fallback_font(Script::Arabic,
                                        Font::from_file(get_asset_dir("fonts/NotoSansArabic-Regular.ttf")));
    text_server->register_fallback_font(Script::Hangul, Font::from_file(get_asset_dir("fonts/NotoSansKR-Regular.ttf")));
    text_server->register_fallback_font(Script::Han, Font::from_file(get_asset_dir("fonts/NotoSansSC-Regular.ttf")));
    auto jp = Font::from_file(get_asset_dir("fonts/NotoSansJP-Regular.ttf"));
    ...
    text_server->register_fallback_font(Script::Bengali,
                                        Font::from_file(get_asset_dir("fonts/NotoSansBengali-Regular.ttf")));
    text_server->register_fallback_font(Script::Thai, Font::from_file(get_asset_dir("fonts/NotoSansThai-Regular.ttf")));
}
